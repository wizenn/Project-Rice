...
export default function Register() {
    ...
    return (
        ...
        <main className="fixed inset-0 z-[9999] bg-white flex items-center justify-center px-4 py-12 text-gray-900 gap-4">
            <div
            ...
            >
                ...
                <form className="w-full" onSubmit={handleSubmit}>
                    ...
                    <div className="relative text-gray-500 focus-within:text-gray-900 mb-9">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <p className="inline-block font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <span className="text-gray-800 ">Điều khoản sử dụng</span>{" "}
                            và{" "}
                    ...
                    <div className="mt-5 ">
                        <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                            ...
                            <Link
                                href="/login"
                                className="text-brand-500 ml-4 hover:text-brand-600 dark:text-brand-400"
                            >
                                Đăng Nhập
                            </Link>
                        </p>
