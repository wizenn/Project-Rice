                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        ...
                        <div className="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                            <a href="/" className="w-9 h-9 rounded-full bg-indigo-600 flex justify-center items-center hover:bg-indigo-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white w-4 h-4" viewBox="0 0 16 16">
                    ...
                    <div className="lg:mx-auto text-center sm:text-left">
                        ...
                        <ul className="text-sm transition-all duration-500">
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Trang chủ</a></li>
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Giới thiệu</a></li>
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Bảng giá</a></li>
                            <li><a href="/" className="text-gray-600 hover:text-gray-900">Tính năng</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-center sm:text-left">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Sản phẩm</h4>
                        <ul className="text-sm transition-all duration-500">
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Figma UI System</a></li>
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Biểu tượng</a></li>
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Khối responsive</a></li>
                            <li><a href="/" className="text-gray-600 hover:text-gray-900">Thư viện component</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-center sm:text-left">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Tài nguyên</h4>
                        <ul className="text-sm transition-all duration-500">
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Câu hỏi thường gặp</a></li>
                        </ul>
                    </div>
                </div>
            </div>
