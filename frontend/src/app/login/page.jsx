...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (data.EC === 0) {
                localStorage.setItem('token', data.token); // nếu BE trả về token
                ...
                <form className="w-full" onSubmit={handleSubmit}>
                    ...
                    <div className="flex mb-5">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-12 bg-indigo-600 hover:bg-indigo-900 transition-all duration-700 rounded-full shadow-xs text-white text-base font-semibold leading-6 disabled:opacity-50"
                        >
                    ...
                    <div className="mt-5 ">
                        <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                            ...
                            <Link
                                href="/register"
                                className="text-brand-500 ml-2 hover:text-brand-600 dark:text-brand-400"
                            >
                                Đăng Ký
                            </Link>
                        </p>
